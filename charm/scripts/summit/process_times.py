...
for node_count in node_count_list:
  ...
  writer.writerow([str(node_count * gpu_count), str(odf_1_avg), str(odf_1_stdev), str(odf_2_avg), str(odf_2_stdev), str(odf_4_avg), str(odf_4_stdev), str(odf_8_avg), str(odf_8_stdev)])
